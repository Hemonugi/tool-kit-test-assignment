 ...
 */
final class Version20230610202238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application ADD creator_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A45BDDC161220EA6');
        $this->addSql('ALTER TABLE application DROP creator_id');
    }
}
